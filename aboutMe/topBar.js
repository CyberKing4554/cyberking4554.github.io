...
function drawHacksButton(){
  if(mouseX > (topBarX/2)-50 && mouseX < (topBarX/2)+50 && mouseY >12 && mouseY < 37){
    ...
    if(mouseIsPressed){
      window.location.href = 'https://cyberking4554.github.io/hacks/';
    }
  }
  textAlign(CENTER);
  fill(textColor);
...
function drawSidebarButtons(){
    ...
    if(mouseIsPressed){
      window.location.href = 'https://cyberking4554.github.io/hacks/'; // PUT PAGE WEBSITE HERE!
    }
  }
  textAlign(CENTER);
  fill(textColor);
  ...
  textFont(font2);
  textSize(20);
  text("Home",(animationState*4)-100,155);
  ...
  textFont(font2);
  textSize(20);
  text("Gallery",(animationState*4)-100,255);
}
